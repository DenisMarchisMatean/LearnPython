...
import requests
from FlaskWeatherAPI.utils.constants import WEATHER_API_KEY, WEATHER_API_TIMELINE_BASE_URL
...
def index():
    ...
    url = f"{WEATHER_API_TIMELINE_BASE_URL}/{city},{country_shorten}/{start_date}/{end_date}?key={WEATHER_API_KEY}"
